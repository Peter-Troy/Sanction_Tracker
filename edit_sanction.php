...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM sanction_tracker WHERE id = $id";
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            if (isset($_POST['submit'])) {
                ...
                $Uquery = "UPDATE sanction_tracker SET

                    sanction = '" . mysqli_real_escape_string($conn, $_POST['sanction']) . "',
                    sanction_description = '" . mysqli_real_escape_string($conn, $_POST['sanction_description']) . "'
                ...
                <div class="formm">
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            <label for="sanction" class="form-label" style="font-weight: bold;">SANCTION:</label>
                            <input type="text" class="form-control" id="sanction" name="sanction" value="<?php echo $id['sanction']; ?>">
                        </div>

                        <div class="form-group">
                            <label for="sanction_description" class="form-label" style="font-weight: bold;">SANCTION DESCRIPTION:</label>
                            <input type="text" class="form-control" id="sanction_description" name="sanction_description" value="<?php echo $id['sanction_description']; ?>">
                        </div>
                        <button type="submit" name="submit" class="btn btn-outline-primary">Update</button>
                        <a class="btn btn-success" href="sanction.php" role="button">View Updated Entry</a>
...
<script>
    ...
    function confirmDelete() {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            window.location.href = "delete_sanction.php?id=<?php echo $id['id']; ?>";
        }
    }
</script>
