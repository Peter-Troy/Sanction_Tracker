    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            if (isset($_POST['submit'])) {
                ...
                $Uquery = "UPDATE providers SET

                    provider_name = '" . mysqli_real_escape_string($conn, $_POST['provider_name']) . "',
                    provider_description = '" . mysqli_real_escape_string($conn, $_POST['provider_description']) . "'
                ...
                <div class="formm">
                    <form method="post" action="">
                        <div class="form-group">
                            <label for="provider_name" class="form-label" style="font-weight: bold;">Provider:</label>
                            <input type="text" class="form-control" id="provider_name" name="provider_name" value="<?php echo $id['provider_name']; ?>">
                        </div>

                        <div class="form-group">
                            <label for="provider_description" class="form-label" style="font-weight: bold;">Provider Description:</label>
                            <input type="text" class="form-control" id="provider_description" name="provider_description" value="<?php echo $id['provider_description']; ?>">
                        </div>
                        <button type="submit" name="submit" class="btn btn-outline-primary">Update</button>
                        <a class="btn btn-success" href="provider.php" role="button">View Updated Entry</a>
...
<script>
    ...
    function confirmDelete() {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            window.location.href = "delete_provider.php?id=<?php echo $id['id']; ?>";
        }
    }
</script>
