        ...
        <nav class="navbar">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="sanction_entry.php" class="btn btn-outline-success " tabindex="-1" role="button" aria-disabled="true">Add Sanction</a>
                    </div>
                </div>
                </form>
...
$sqlFilteredRecords = "SELECT * FROM sanction_tracker 
                       WHERE $searchConditions
                       ORDER BY sanction ASC";
    ...
    $sqlAllRecords = "SELECT * FROM sanction_tracker ORDER BY sanction ASC";
...
if (count($subsetRecords) > 0) {
    foreach ($subsetRecords as $row) {
        ...
        echo "<td>" . $row["sanction_description"] . "</td>";
        echo "<td><a href='edit_sanction.php?id=" . $row["id"] . "' ><img src='icons/edit.png' alt='Edit' class='edit-icon'></a></td>";
